// Vendored from @earendil-works/pi (packages/ai/src/auth/oauth/xai.ts),
// MIT License, Copyright (c) 2025 Mario Zechner. See THIRD_PARTY_NOTICES.md.
// Modified: refresh() owns its request timeout.
...
export async function refreshXai(
